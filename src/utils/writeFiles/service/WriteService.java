...
public class WriteService {
	...
	public  void createFiles(String dirs,String url,String pKey,String tableName) throws IOException{
        ...
        if(!file.exists()){
            ...
            sb.append("	* @return\n");
            sb.append("	*/ \n");
            sb.append("    List<"+lowerName+"> select"+lowerName+"ByParam(Map paramMap); \n\n");
            sb.append("	/**\n");
            sb.append("	* 更新 \n");
            sb.append("	* @return \n"); 
            sb.append("	*/ \n"); 
            sb.append("    int update"+lowerName+"("+lowerName+" "+tableName.toLowerCase()+");\n\n");
            sb.append("	/**\n");
            sb.append("	* 添加 \n");
            sb.append("	* @return\n");  
            sb.append("	*/ \n"); 
            sb.append("    int add"+lowerName+"("+lowerName+" "+tableName.toLowerCase()+");\n\n");
            sb.append("	/**\n");
            sb.append("	* 批量添加 \n");
            sb.append("	* @return\n");  
            sb.append("	*/ \n"); 
            sb.append("    int muladd"+lowerName+"(List<"+lowerName+"> list);\n\n");
            sb.append("	/**\n");
            sb.append("	* 删除 \n");
            sb.append("	* @return \n"); 
            sb.append("	*/ \n"); 
            sb.append("    int delete"+lowerName+"(String id);\n\n");
            sb.append("}\n\n");
